      ...
      <div className="sidebar__menu">
        <ul className="sidebar__list">
          <li className="sidebar__listItem ">
            <svg className='sidebar__icon' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="sidebar__listItem">
            <svg className='sidebar__icon' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="sidebar__listItem active">
            <svg className='sidebar__icon' width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="sidebar__listItem">
            <svg className='sidebar__icon' width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="sidebar__listItem">
            <svg className='sidebar__icon' width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="sidebar__listItem">
            <svg className='sidebar__icon' width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="sidebar__listItem">
            <svg className='sidebar__icon' width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
